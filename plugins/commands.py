...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🍁 Movies Grup 🍁', url='https://t.me/SwiftHornRequest')
                ],[
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("Dᴇᴠ", url="t.me/Royaldwip")
                         ]
                        ]
                    )
                )
    ...
    if not files_:
        ...
        try:
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                      ...
                      InlineKeyboardButton("Dev", url="t.me/Royaldwip")
                     ]
                    ]
                )
            )
            ...
            btn = [[
                InlineKeyboardButton("Recover File!", callback_data=f'delfile#{file_id}')
            ]]
            k = await msg.reply("<b><i>𝖠𝖻𝗈𝗏𝖾 𝖿𝗂𝗅𝖾 𝗐𝗂𝗅 𝖻𝖾 𝖺𝗎𝗍𝗈 𝖽𝖾𝗅𝖾𝗍𝖾 𝗂𝗇 10 𝗆𝗂𝗇𝗎𝗍𝖾𝗌 𝗄𝗂𝗇𝖽𝗅𝗒 𝖽𝗈𝗐𝗇𝗅𝗈𝖺𝖽 𝖺𝗇𝖽 𝗌𝖺𝗏𝖾 𝗂𝗍...</i></b>",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
            await k.edit_text("<b>𝖠𝖻𝗈𝗏𝖾 𝖿𝗂𝗅𝖾 𝗌𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝖽𝖾𝗅𝖾𝗍𝖾𝖽 𝗂𝖿 𝗒𝗈𝗎 𝖽𝗈𝗇'𝗍 𝗌𝖺𝗏𝖾 𝗂𝗍 𝗍𝗁𝖺𝗇 𝖼𝗅𝗂𝖼𝗄 𝖻𝖾𝗅𝗈𝗐 𝖻𝗎𝗍𝗍𝗈𝗇..</b>",reply_markup=InlineKeyboardMarkup(btn))
            return
        except:
            pass
    ...
    k = await msg.reply("<b>🕐 This File Will be Delete in 10 minutes...\n\n↘️ Kindly Forward It Before download!</b>",quote=True)
    await asyncio.sleep(600)
    await msg.delete()
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink GreyMatterslinks.in  3b7014f145818b00af237574d918cdabbe523488</code></b>")
