...
BOT_TOKEN = environ.get('BOT_TOKEN', "6226398171:AAHkhHdT0iLjU99yraJCuyiXr7xWjgfYCuc")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1782834874').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001774060800')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001914960205')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '514adf63a7df267e24d7d846250f97af28cc2ae1')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/tutorial_videoss/2')
...
LANGUAGES = ["hindi", "480p", "english", "720p" ,"tamil", "1080p", "telugu", "480p 10bit", "malayalam", "720p 10bit", "kannada", "1080p 10bit", "Punjabi", "720p HEVC", "Bengali", "1080p HEVC", "Pre", "Web"]
