...
✯ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/ShinchanFilterRobot>Shinchan Bot</a>
 ✯ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/RoyalDwip'>Royal Dwip</a> 
 ✯ ʟɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a> 
 ✯ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 3</a> 
 ✯ ᴅᴀᴛᴀ ʙᴀsᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏ ᴅʙ</a> 
 ✯ ʙᴏᴛ sᴇʀᴠᴇʀ : <a href='https://heroku.com'>HEROKU</a> 
 ✯ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : Version-8.5.0 [sᴛᴀʙʟᴇ]></b>"""

    SOURCE_TXT = """<b>Dear,
-<i> I know Ki Tum Yeha Kyu Aye Hoon But Still I Can't Give You Repo Because Mene isme kuch Changes Kiya Hain So Dafa Ho Jao Yeha Se Agr Ye Msg Padkar tumara dimag kharab ho jaye and tum bot ko block kar do to fhir jab unblock karoge tab tum banned user ke list me chale jayoge 👺</i></b>"""
...
<b>ɴᴏᴛᴇ:</b>
 ...
 ✯ /song - Download any song [<code>example /song Udja kale kawa</code>] 
...
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?"""
    ...
    I_CUDNT = """<b>Sorry,\nNo Files Found For `{}` !\n\nReason Are....👇\n• PreDvD / OTT Web-DL Quality Not Release For `{}`\n• I Think `{}'s` Files Are Not Added In My Database\n• Another Reason Spelling Incorrect Kindly Chek Spelling On Google By Click Below Google Button 👇</b>"""
    I_CUD_NT = """ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}.
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""

    MVE_NT_FND = """<b>Mᴏᴠɪᴇ Nᴏᴛ Fᴏᴜɴᴅ Iɴ ᴅᴀᴛᴀʙᴀꜱᴇ...\n\nReasons 👇\n\nI think These movie not Release Or Not Added in my database kindly Contact My Owner 😜</b>"""
    ...
    SHORTLINK_INFO = """
<b>──────「<a href=https://t.me/tutorial_videoss/4> Hᴏᴡ ᴛᴏ Eᴀʀɴ Mᴏɴᴇʏ </a> 」──────
...
sᴛᴇᴘ 𝟸 : ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ Aɴʏ <a href=https://GreyMatterslinks.in/ref/Royaldwip>Sʜᴏʀᴛᴇɴᴇʀ Wᴇʙsɪᴛᴇ</a>.

sᴛᴇᴘ 𝟹 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ <a href=https://t.me/tutorial_videoss/4> ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ </a>Tᴏ ᴄᴏɴɴᴇᴄᴛ sʜᴏʀᴛᴇɴᴇʀ.

➣ Yᴏᴜ ᴄᴀɴ ᴄᴏɴɴᴇᴄᴛ ᴀs ᴍᴀɴʏ ɢʀᴏᴜᴘ ʏᴏᴜ ʜᴀᴠᴇ.

Any Doubts or Not Connecting? Contact Me @RoyalDwip 🚩</b>
"""
...
Movie Provided By [ <a href=https://t.me/Wombackup> Wombackup 🚩 </a>]</b>""" 
    ...
    IMDB_TEMPLATE_TXT = """
IMDB Data Generate For : {query} 
Requested By : {message.from_user.mention} ❤
     <•⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯•>
• Name</b>: <a href={url}>{title}</a>
• Genres: {genres}
...
⏰ Files Ready in : {remaining_seconds} <i>seconds</i> 🔥</b>"""
...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code>Version-8.5.0 [ Sᴛᴀʙʟᴇ ]</code></b>"""
